...
import JoshComponent from '../../App/Components/JoshComponent'

const wrapper = shallow(<JoshComponent />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('JoshComponent Component')) // That the Component Text is included
})
